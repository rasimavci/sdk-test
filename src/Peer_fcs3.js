...
class Peer_fcs3 {
    constructor() {
        ...
        this.loginMethod = new jet.Method('todo/login3');
        ...
        this.logoutMethod = new jet.Method('todo/logout3');
        this.logoutMethod.on('call', function (args) {
            console.log('Peer: logout method called..');
            self.logout()
        });

        this.callMethod = new jet.Method('todo/makeCall3');
        ...
        this.answerMethod = new jet.Method('todo/answerCall3');
        ...
        this.holdMethod = new jet.Method('todo/hold3');
        ...
        this.unholdMethod = new jet.Method('todo/unhold3');
        ...
        this.endMethod = new jet.Method('todo/end3');
        ...
        this.rejectMethod = new jet.Method('todo/reject3');
        this.rejectMethod.on('call', function (args) {
            ...
            self.currentCall.reject(function () {
                self.showInfoMessage("Call is reject!");
            },

                function () {
                    self.showErrorMessage("Call couldn't be rejected!");
                });
        });  

        this.ignoreMethod = new jet.Method('todo/ignore3');
        ...
        this.videoStartMethod = new jet.Method('todo/videoStart3');
        this.videoStartMethod.on('call', function (args) {
            ...
            self.currentCall.videoStart(function () {
                self.showInfoMessage("Call is videoStart!");
            },

                function () {
                    self.showErrorMessage("Call couldn't be videoStart!");
                });
        });  

        this.videoStopMethod = new jet.Method('todo/videoStop3');
        this.videoStopMethod.on('call', function (args) {
            ...
            self.currentCall.videoStop(function () {
                self.showInfoMessage("Call is videoStop!");
            },
        ...
        this.setPresenceMethod = new jet.Method('todo/setPresence3');
        this.setPresenceMethod.on('call', function (args) {
            ...
            console.log('Peer: presence state..');
                  ...
                  self.updatePresenceState(args[0],
                    //Success callback
                    function() {
                        self.showInfoMessage("Presence state is set to " + args[0]);
                    },
                    //Failure callback
                    function() {
                        self.showErrorMessage("Presence state couldn't be changed!");
                    }
                );
        });  
        ...
        this.peer.add(this.videoStartMethod).then(function () {
            console.log('Peer3: videoStart method added')
        })    

                this.peer.add(this.videoStopMethod).then(function () {
            console.log('Peer3: videoStop method added')
        })    
...
var self = this;
  ...
  self.peer.set('todo/#' + id, {
    ...
    login(id) {
        ...
        password = 'ltve0168' //$("#confPassword").val();
      ...
      self.peer.get({ path: { equals: 'todo/#0' } }).then(function (results) {
        ...
        console.log('sonuc3:' + results[0].value.secondCall)
        let secondCall = results[0].value.secondCall
...
var id = 1;
        ...
        switch (state) {
            ...
            case fcs.call.States.RINGING:
                self.showSuccessMessage("It is ringing...",self);
                break;
            ...
            case fcs.call.States.ANSWERING:
                self.showSuccessMessage("The call is being answered",self);
                break;
